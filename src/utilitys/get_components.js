...
const componentsMapping = {
  ...
  CoulorBarChart: defineAsyncComponent(() =>
    import("@/components/CoulorBarChart.vue")
  ),
  CircleChart: defineAsyncComponent(() =>
    import("@/components/CircleChart.vue")
  ),
  ImageTable: defineAsyncComponent(() =>
    import("@/components/DrawImageTable.vue")
  ),
  ...
  CardWithButton: defineAsyncComponent(() =>
    import("@/components/CardWithButton.vue")
  ),
};
