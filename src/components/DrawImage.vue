...
created() {
    ...
    if (this.Data.Object in this.DataBase) {
        this.image1 = GetSlotComponentData('DrawOnImage', this.DataBase[this.Data.Object].First);
        this.image2 = GetSlotComponentData('DrawOnImage', this.DataBase[this.Data.Object].Second);
