...
export default {
  ...
  mounted() {
    ...
    if (
      this.Data.Scale != 1000 &&
      this.Data.Scale != 250 &&
      this.Data.Scale != 2000
    ) {
      console.warn(
        `SlotComponent(Water): this.Data.Scale must be 1000, 250 or 2000, not ${this.Data.Scale}, set to 2000 by default`
      );
      this.Data.Scale = 2000;
    }
    ...
    img.src = getSlotComponentAssets("Water", `${this.Data.Scale}.png`);
